    ...
    def get_sale_details(self, date_start=False, date_stop=False, config_ids=False, session_ids=False):
        ...
        return {
            ...
            'products': sorted([{
                ...
                'percentage': (((qty * price_unit) - (qty * product.standard_price)) / (qty * product.standard_price) if product.standard_price != 0 else 0) * 100 if product.standard_price != 0 else 0,
